							...
							<div class="padding_eight_all bg-white">
								...
								<form action="{{ route('login') }}" method="post">
									...
									<div class="form-group">
										<input type="text" class="form-control{{ ($errors->has('email') || $errors->has('username')) ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="Email hoặc Username *" required />
									...
									<div class="login_footer form-group">
										...
										<a href="{{route('user.quen-mat-khau')}}">Quên mật khẩu?</a>
									</div>
									<div class="form-group">
