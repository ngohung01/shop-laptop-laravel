				...
				<tbody>
					@foreach($sanpham as $value)
						<tr>
							...
							{{-- <td class="text-center"><img src="{{ env('APP_URL') . '/storage/app/' . $value->hinhanhkhac }}" width="80" class="img-thumbnail" /></td> --}}
							...
							<td class="text-end">{{ $value->smotasanpham }}</td>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="background-color: red;color:aliceblue">&times;</button>
					</div>
